...
`,
  ...
  { 
    ...
    description: 'Az elkészült nyomtatott áramkörhöz kollégáink burkolatot terveznek a megrendelő igényei szerint. Prototípus házakat tudunk készíteni 3D nyomtatással, CNC megmunkálással, PU vákuumöntéssel LPM technológiával és kisszériás fröccsöntőszerszámmal.',
    descriptionOne: 'Elektronikai fejlesztő cég vagyunk, ez nem vitás. Ez az amihez a legjobban értünk. Jogosan merül fel tehát a kérdés, miért foglalkozunk akkor mechanikai tervezéssel? Amikor egy elektronikát legyártunk, az szinte minden esetben valamilyen készülékházba fog kerülni. A készülékház megtervezése egy komplex feladat.Gyakran szenzorokat tervezünk. A ház védeni fogja az elektronikát a külső behatásoktól. Ugyanakkor bizonyos fizikai jellemzőket „be kell engednünk” a panelen lévő szenzorig. A tervezés során tekintettel kell lenni az elektronika működésére, hol milyen szenzorok vannak rajta. Akár, ha csak egy egyszerű hőmérséklet szenzort veszünk példaképp, akkor nagyon nem mindegy, hogyan oldjuk meg, hogy a mérendő hőmérséklet optimálisan tudjon hatni a szenzorra.',
    imgUrlOne: 'images/mechanikai/img1.jpg',
    descriptionTwo: 'Egyszerűbb tervezési feladatokat saját munkatársaink is el tudnak végezni. Abban az esetben, ha komplex készüléket, professzionális burkolatot kell tervezni, az együttműködő partnereinkhez fordulunk segítségért. A Barna Design a burkolat és az arculat megtervezésében nyújt professzionális szolgáltatást. A Plastic-Form Kft kiváló partnerünk, a komplex mechanikai tervezésben és a műanyagalakító szerszámok tervezésében velük dolgozunk együtt. Több évtizedes tapasztalatuknak és a műanyagiparra való széles rálátásuknak köszönhetően eddig még nem találkoztunk olyan kihívással, amit ne tudtak volna megoldani.',
